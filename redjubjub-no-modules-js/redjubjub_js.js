...
* @returns {string}
*/
__exports.generate_rk_by_ask = function(ask_string, alpha_string) {
    try {
...
* @returns {string}
*/
__exports.generate_spend_auth_sig = function(ask_string, alpha_string, message_hash_string) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passStringToWasm0(ask_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
...
* @returns {boolean}
*/
__exports.verify_spend_auth_sig = function(rk_string, message_hash_string, signature_string) {
...
* @returns {string}
*/
__exports.generate_pk_by_sk = function(sk_string) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {string}
*/
__exports.generate_binding_sig = function(sk_string, message_hash_string) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passStringToWasm0(sk_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
...
* @returns {boolean}
*/
__exports.verify_binding_sig = function(pk_string, message_hash_string, signature_string) {
...
* @returns {any}
*/
__exports.generate_keys = function() {
...
* @returns {any}
*/
__exports.generate_keys_by_sk = function(sk_str) {
...
* @returns {any}
*/
__exports.generate_keys_by_sk_d = function(sk_str, d_str) {
    var ptr0 = passStringToWasm0(sk_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
